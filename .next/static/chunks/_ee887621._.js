(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_ee887621._.js", {
...
_s(BaseButton, "VrMvFCCB9Haniz3VCRPNUiCauHs=", false, function() {
    return [
...
const registerUserByTaxId = async (taxId, user_id)=>{
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`http://192.168.64.92:4004/api/line/registerRichMenuToUser?tax_id=${taxId}&user_id=${user_id}`);
    } catch (error) {
        throw error;
    }
};
...
const RegisterForm = ()=>{
    ...
    const regisger = async (data)=>{
        setLoading(true);
        try {
            var response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$register$2f$services$2f$regisger_service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerUserByTaxId"])(data.tax_id, data.user_id);
...
//# sourceMappingURL=_ee887621._.js.map