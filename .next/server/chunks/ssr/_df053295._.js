...
const registerUserByTaxId = async (taxId, user_id)=>{
    ...
    // return await axios.get("https://api-line-bot.homeone.co.th/api/line/registerRichMenuToUser", {
    //     params: { tax_id: "123456", user_id: "123456" },
    // });
    // let config = {
    //     method: 'post',
    ...
    //     headers: {}
    // };
    // return await axios.reque       
    // return await axios.post(`https://api-line-bot.homeone.co.th/api/line/registerRichMenuToUser?tax_id=${taxId}&user_id=${user_id}`,);
    } catch (error) {
        throw error;
    }
};
...
//# sourceMappingURL=_df053295._.js.map